...
if __name__ == "__main__":
    ...
    plot_and_save_class_distribution(train_dataset, "Class Distribution - Training", "train", run_dir, class_names)
    plot_and_save_class_distribution(val_dataset, "Class distribution - Validation", "val", run_dir, class_names)
    plot_and_save_class_distribution(test_dataset, "Class distribution - Test", "test", run_dir, class_names)
